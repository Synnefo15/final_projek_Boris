...
<html>
    ...
    <head>
        ...
        <link rel="icon"
            href="https://media.istockphoto.com/vectors/abstract-linear-letter-b-logo-icon-design-modern-minimal-style-vector-id1266158382?k=20&m=1266158382&s=612x612&w=0&h=BeyYMmwxPeJ8V9GeHZHsrDksH3A0bwThT8kDTlinhYQ=">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index.php" class="brand-link">
                    <img src="dist/img/masjid.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
    ...
    ?>
            ...
            <footer class="main-footer">
                ...
                Copyright &copy;<a target="_blank" href="https://www.facebook.com/radenmas.brono"><strong> elseif
                        software house</strong></a>
                All rights reserved.
            </footer>
