	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="uraian_ks" name="uraian_ks" placeholder="Uraian Pengeluaran" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO kas_sosial (tgl_ks,uraian_ks,masuk,keluar,jenis) VALUES (
        '".$_POST['tgl_ks']."',
        '".$_POST['uraian_ks']."',
        '0',
        '".$keluar_hasil."',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=o_add_ks';
          }
      })</script>";
    }}
