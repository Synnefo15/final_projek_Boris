<div class="card card-secondary">
  ...
  <form action="./report/kas_sosial_per.php" method="post" enctype="multipart/form-data" target="_blank">
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <a href="./report/kas_sosial_full.php" class="btn btn-primary" target="_blank">Cetak Semua</a>
    </div>
  </form>
</div>
